// components/share/PlayerCard.tsx
...
export function PlayerCard(props: Readonly<{
    ...
    return (
        <div className="w-full relative">
            ...
            <div className="grid grid-cols-1 gap-6 items-start">
                {/* PLAYER */}
                <div
                    className="rounded-3xl border border-stone-200 bg-white/70 shadow-2xl shadow-rose-100/40 backdrop-blur overflow-hidden">
                    <div className="relative aspect-video bg-stone-100 overflow-hidden">
                        ...
                        {props.videoUrl ? (
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-center">
                                    <div
                                        className="mx-auto h-12 w-12 rounded-2xl border border-stone-200 bg-white/70 shadow-sm backdrop-blur flex items-center justify-center">
                        ...
                        >
                            <div
                                className="rounded-2xl border border-stone-200 bg-white/80 shadow-sm backdrop-blur p-4">
                    ...
                    <span
                        className="px-2 py-1 rounded-full border border-stone-200 bg-white text-[10px] uppercase font-bold tracking-wider text-stone-700">
                      HD
                    </span>
                                        <span
                                            className="px-2 py-1 rounded-full border border-stone-200 bg-white text-[10px] uppercase font-bold tracking-wider text-stone-700 tabular-nums">
                      {pct}%
                    </span>
                                    </div>
                                </div>
                ...
                <div className="relative">
                    ...
                    <div
                        className="rounded-3xl border gap-x-4 border-stone-200 bg-white/70 shadow-sm backdrop-blur p-4 grid grid-cols-1 md:grid-cols-2">
                        <div
                            className="md:col-span-2 w-max inline-flex items-center gap-2 rounded-full border border-stone-200 bg-white/80 px-3 py-1 text-xs text-stone-700 shadow-sm backdrop-blur">
                        ...
                        <div className="mt-3 order-3 rounded-2xl border border-stone-200 bg-white overflow-hidden">
                            {hasThumb ? (
                                ...
                                <div className="h-40 flex items-center justify-center bg-stone-50">
                                    <div className="text-center">
                                        <div
                                            className="mx-auto h-10 w-10 rounded-2xl border border-stone-200 bg-white flex items-center justify-center">
                        ...
                        {!showInfoOnPlayer ? (
                            <div
                                className="mt-4 md:order-4 rounded-2xl border border-stone-200 bg-white/80 p-3 h-max mb-auto">
