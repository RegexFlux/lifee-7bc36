            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <p className="text-stone-500 text-lg">
                        Pas besoin de compétences techniques. Vous êtes le réalisateur de votre histoire, nous nous
                        occupons de la magie.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i}
                             className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-stone-100 relative overflow-hidden group">
                            <div
                                className="absolute top-0 right-0 p-4 opacity-70 font-serif text-6xl font-bold text-stone-300 group-hover:text-rose-200 transition-colors">
                                {card.step}
                            </div>
