        ...
        <nav className="relative px-6 py-6 max-w-7xl mx-auto flex justify-between items-center z-10">
          ...
          Lifee
            ...
            <div className="hidden md:flex gap-8 text-sm font-medium text-stone-500">
                <a href="#difference" className="hover:text-rose-600 transition-colors">Différence</a>
                <a href="#exemples" className="hover:text-rose-600 transition-colors">Exemples</a>
                <a href="#occasions" className="hover:text-rose-600 transition-colors">Occasions</a>
            ...
            >
                Connexion{" "}
                <span className="bg-amber-500 text-white text-[10px] px-1.5 rounded-full font-bold">
          +5
        </span>
            </button>
        </nav>
